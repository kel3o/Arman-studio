...
const SECTIONS = [
  ...
  {
    title: "صدا",
    body: "جدول سه ستونه: اسم گوینده، حس صدا، و جنسیت. روی ردیف بزن تا همان صدا انتخاب شود. ردیف انتخاب‌شده مشخص می‌ماند.",
  },
  {
    title: "سبک خواندن",
    body: "چند سبک از پیش آماده مثل رسمی، داستانی یا خبری. انتخاب سبک روی لحن کلی خواندن اثر می‌گذارد و جدا از برچسب‌های لحظه‌ای داخل متن است.",
  },
  {
